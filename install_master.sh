...
habilitando_ecaminhamentos_portas_tuneis(){
    ...
    ssh $VPS_USER@$VPS_IP "sudo sed -i.bak '/^#GatewayPorts yes/s/^#//; /GatewayPorts no/s/no/yes/; /GatewayPorts yes/!s/^/GatewayPorts yes\n/' $SSH_CONFIG_FILE && sudo systemctl restart ssh"

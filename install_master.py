...
""")
    ...
    def instala_filebrowser(self,):
        ...
        for tentativa in range(12):  # 12 tentativas x 5 segundos = 60 segundos
            ...
            try:
                # Executa o comando docker logs diretamente
                result = subprocess.run(
                ...
                # Busca pela senha no log completo
                for linha in logs_completos.splitlines():
...
if __name__ == "__main__":
    ...
    try:
        ...
        if container_name not in check_result.stdout:
            ...
            print(f"Erros (stderr): {result.stderr}")
            
            if result.stdout.strip():
                print("✅ Logs capturados com sucesso!")
            else:
                print("⚠️ Logs vazios - container pode não ter gerado saída ainda")
